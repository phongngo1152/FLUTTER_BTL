...
<!-- color-customizer END -->
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/countdown.min.js"></script>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/apexcharts.js"></script>
	<!-- lottie JavaScript -->
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/smooth-scrollbar.js"></script>
	<!-- Style Customizer -->
	<script
		src="${pageContext.request.contextPath}/resources/js/style-customizer.js"></script>
	<!-- Chart Custom JavaScript -->
	<script
		src="${pageContext.request.contextPath}/resources/js/chart-custom.js"></script>
	<!-- Custom JavaScript -->
