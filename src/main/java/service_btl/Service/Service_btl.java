...
public class Service_btl {
		...
		List<Account> listCategory = new AccountDaoImpl().getAllUser();
		 ...
		 List<AccountDTO> listData = new ArrayList<AccountDTO>();
	        for (Account c : listCategory) {
	        	AccountDTO cdto = new AccountDTO(c.getAcId(), c.getUserName(),c.getEmail(), c.getPassword(), c.getRole(), c.getCreateAt(), c.getUpdateAt(), c.getStatus());
	                     listData.add(cdto);
	        }
	...
	public String getAccountById(@PathParam("id") Integer id) {
	    ...
	    Gson gson = new Gson();
	    AccountDTO adto = new AccountDTO(account.getAcId(), account.getUserName(), account.getEmail(), account.getPassword(), account.getRole(), account.getCreateAt(), account.getUpdateAt(), account.getStatus());
	...
	public String insertAccount(String a) {
	    ...
	    Account account = new Account(objDTO.getAcId(), objDTO.getUserName(), objDTO.getEmail(), objDTO.getPassword(), objDTO.getRole(), objDTO.getCreateAt(), objDTO.getUpdateAt(), objDTO.getStatus());
	...
	//
	    ...
	    public String insertChapter(String chapterData) {
	        ...
	        Chapter chapter = new Chapter(
	            chapterDTO.getChapterId(),
	            objStory, // Tìm Story từ id
	            chapterDTO.getChapterTitle(),
	            chapterDTO.getContent(),
	            chapterDTO.getChapterNumber(),
	            chapterDTO.getCreateAt(),
	            chapterDTO.getUpdateAt(),
	            chapterDTO.getStatus()
	        );
	...
	//
	    ...
	    public String getAllComments() {
	        ...
	        for (Comment comment : commentList) {
	            CommentDTO commentDTO = new CommentDTO(
	                ...
	                comment.getAccount().getAcId(), // Map accountId
	    ...
	    public String getAllFavorites() {
	        ...
	        for (Favorite favorite : favoriteList) {
	            FavoriteDTO favoriteDTO = new FavoriteDTO(
	                ...
	                favorite.getStory().getStoryId(),
	                favorite.getCreateAt(),
	                favorite.getUpdateAt(),
	                favorite.getStatus()
	            );
	    ...
	    public String insertFavorite(String favoriteData) {
	        ...
	        Favorite favorite = new Favorite(
	            ...
	            account,
	            story,
	            favoriteDTO.getCreateAt(),
	            favoriteDTO.getUpdateAt(),
	    ...
	    public String getAllViews() {
	        ...
	        for (View view : viewList) {
	            ViewDTO viewDTO = new ViewDTO(
	                view.getViewId(),
	                view.getAccount().getAcId(),
	                view.getStory().getStoryId(),
	                view.getChapter().getChapterId(),
	                view.getViewedAt(),
	                view.getCreateAt(),
	                view.getUpdateAt(),
	                view.getStatus()
